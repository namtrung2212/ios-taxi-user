...
open class TravelHistoryScreen: UIViewController {
    ...
    func initControls(_ completion: (() -> ())?){
        ...
        let btnBack = UIBarButtonItem(title: "", style: .plain, target: self, action: #selector(TravelHistoryScreen.btnBack_Clicked))
